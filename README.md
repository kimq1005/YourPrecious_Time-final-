# Your_PreciousTime(경기교통정보서비스 - MVVM 도입중)
...
1차. 기존에 알고있던 기술로 프로젝트를 완성하기  (End).  
...
* 함수와 싱글톤 패턴을 적극 사용해보면서 매번 새로운 객체를 생성하지 않아도 되는 편리함을 깨닫게 되었음.
...
# 📖Second learning
* Mvvm패턴의 도입으로 클린아키텍쳐의 이점과 사용법을 알게 되었음.
* JetPack(DataBinding, LiveData, ViewModel, Repository)의 사용법과 이점을 알게 되었음.
* 반복코드를 줄임으로써 가독성을 높일수 있었음.
* 주석 작성의 중요성을 깨닫게 되었음. 
